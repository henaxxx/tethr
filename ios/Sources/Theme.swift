...
/// 暗く中立な地の上で見るのが、現像ソフトやカメラの背面液晶と同じ条件になる
enum Theme {
    /// 画面の地。写真の周りもこの色にして、余白が帯に見えないようにする
    static let background = Color(red: 0.051, green: 0.051, blue: 0.059)     // #0D0D0F
    /// スクラバーの溝やボタンの地
    static let surface = Color(red: 0.086, green: 0.086, blue: 0.102)         // #16161A
    static let surfaceRaised = Color(red: 0.114, green: 0.114, blue: 0.133)   // #1D1D22

    static let text = Color(red: 0.918, green: 0.906, blue: 0.886)            // #EAE7E2
    static let dim = Color(red: 0.569, green: 0.553, blue: 0.529)             // #918D87
    static let dimmer = Color(red: 0.388, green: 0.376, blue: 0.361)          // #63605C

    static let amber = Color(red: 0.847, green: 0.639, blue: 0.255)           // #D8A341
    /// 琥珀の上に載せる文字
    static let onAmber = Color(red: 0.165, green: 0.114, blue: 0.024)         // #2A1D06

    static let danger = Color(red: 0.898, green: 0.357, blue: 0.318)
    static let live = Color(red: 0.918, green: 0.263, blue: 0.227)
}
...
extension View {
    /// 丸いボタンの地。iOS 26 では Liquid Glass、それより前は一段明るい地の円
    @ViewBuilder
